...
- [x] ✏️ This displays a help file with a list of possible commands. What does `log` do? **git log shows commit logs**
...
- [x] Set up a [Github page](https://pages.github.com/) "project site" for your repo
  ...
  - [x] ✏️ Paste this link here: [My Site](https://emmelton.github.io/my-awesome-project/) [My Git Repo for the site](https://github.com/emmelton/my-awesome-project)
